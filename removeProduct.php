...
<tr><td width="315"></td><td></td><td><label style="position:relative;"><b>Do you want to remove it?</b></label></td><td><form method="post" action="deleteProductphp.php" ><input type="hidden" name="r1" value="<?php echo $row['CId'];?>" /><input type="hidden" name="r2" value="<?php echo $row['VCode'];?>" /><input type="submit" value="Yes" /></form></td><td><input type="submit" value="No" /></td><td width="320"></td></tr>
</table>
</div>
</div>
<?php
