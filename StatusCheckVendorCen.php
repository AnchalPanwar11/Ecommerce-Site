...
<tr><td>
<div id="heading"><label style="position:relative; font-size:36px; color:#FFF; top:17px"><center><b>Cancelled Orders</b></center></label></div>
<div id="div5"></div>
<?php
session_start();
$a1=$_SESSION['emrid'];
...
$res=mysql_query("select *from addcartlap where Sts='Cancelled'and VCode='$a1'");
