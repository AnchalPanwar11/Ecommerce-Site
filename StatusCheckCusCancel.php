...
<tr><td><div id="sidediv2"></div></td></tr>
<tr><td><div id="sidediv1"><label style="position:relative; left:110px; top:10px"><a href="StatusCheckCusPending.php"><b>Pending Orders</b></a></label></div></td></tr>
<tr><td><div id="sidediv2"></div></td></tr>
...
<tr><td>
<div id="heading"><label style="position:relative; font-size:36px; color:#FFF; top:17px"><center><b>Delivered Orders</b></center></label></div>
<div id="div5"></div>
<?php
session_start();
$a1=$_SESSION['emrid'];
...
$res=mysql_query("select *from addcartlap where Sts='Cancelled' and CUEmailId='$a1'");
