...
<tr><td rowspan="18" height="200" width="220"><div id="picdiv"><img src="../cameraroll/laptopimg.png" height="180" width="180" style="position:relative;left:10px; top:-180px"/></div></td><td width="80"></td><td width="150"><label style="position:relative; left:20px"><b>Price</b></label></td><td><font color="#999999"><?php echo $row['Price']; ?></font></td><td width="30"></td><td><label style="position:relative;"><b>Model Name</b></label></td><td><font color="#999999"><?php echo $row['ModName']; ?></font></td><td width="50"></td></tr>
<tr><td width="80"></td><td><label style="position:relative; right:5px"><center><b>Sales Package</b></center></label></td><td><font color="#999999"><?php echo $row['salePak']; ?></font></td><td></td><td><label style="position:relative;"><b>Case Material</b></label></td><td><font color="#999999"><?php echo $row['CaseM']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative;left:20px"><b>Type</b></label></td><td><font color="#999999"><?php echo $row['Type']; ?></font></td><td></td><td><label style="position:relative;"><b>OS Supported</b></label></td><td><font color="#999999"><?php echo $row['OSSup']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>Designed For</b></label></td><td><input type="text" name="r1" value="<?php echo $row['Designed']; ?>"></td><td></td><td><label style="position:relative;"><b>Internet Key</b></label></td><td><input type="text" name="r2" value="<?php echo $row['IKey']; ?>"></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>Palm Rest</b></label></td><td><font color="#999999"><?php echo $row['PalmRest']; ?></font></td><td></td><td><label style="position:relative;"><b>Touch Pad</b></label></td><td><font color="#999999"><?php echo $row['TouchPad']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>Stand Support</b></label></td><td><font color="#999999"><?php echo $row['StandSup']; ?></font></td><td></td><td><label style="position:relative;"><b>USB Rechargable</b></label></td><td><font color="#999999"><?php echo $row['USB']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>No. of Batteries</b></label></td><td><font color="#999999"><?php echo $row['Battery']; ?></font></td><td></td><td><label style="position:relative;"><b>Switch Type</b></label></td><td><font color="#999999"><?php echo $row['Switch']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>Width</b></label></td><td><font color="#999999"><?php echo $row['Width']; ?></font></td><td></td><td><label style="position:relative;"><b>Height</b></label></td><td><font color="#999999"><?php echo $row['Height']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>Depth</b></label></td><td><font color="#999999"><?php echo $row['Depth']; ?></font></td><td></td><td><label style="position:relative;"><b>Weight</b></label></td><td><font color="#999999"><?php echo $row['Weight']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:20px"><b>Backlit</b></label></td><td><font color="#999999"><?php echo $row['Backlit']; ?></font></td><td></td><td><label style="position:relative;"><b>Warrenty Summary</b></label></td><td><font color="#999999"><?php echo $row['WarrSum']; ?></font></td><td></td></tr>
<tr><td width="80"></td><td><label style="position:relative; left:5px"><b>Covered in Warrenty</b></label></td><td><font color="#999999"><?php echo $row['CWarr']; ?></font></td><td></td><td><label style="position:relative;"><b>Device Type</b></label></td><td><font color="#999999"><?php echo $row['DevType']; ?></font></td><td></td></tr>
</table>
<div id="yesno">
<table height="35" width="1100">
<tr><td width="315"></td><td></td><td><label style="position:relative;"><b>Do you want to remove it?</b></label></td><td><form method="post" action="deleteProductKeyPhp.php" ><input type="hidden" name="r1" value="<?php echo $row['CId'];?>" /><input type="hidden" name="r2" value="<?php echo $row['VCode'];?>" /><input type="submit" value="Yes" /></form></td><td><input type="submit" value="No" /></td><td width="320"></td></tr>
</table>
</div>
</div>
<?php
