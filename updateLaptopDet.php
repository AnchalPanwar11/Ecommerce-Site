...
<tr><td><div id="sidediv2"></div></td></tr>
<tr><td><div id="sidediv1"><label style="position:relative; left:110px; top:10px"><a href="myOrderVendor.php"><b>My Orders</b></a></label></div></td></tr>
<tr><td><div id="sidediv2"></div></td></tr>
...
<tr><td></td><td></td><td><b>Mic IN</b></td><td><input type="text" value="<?php echo $row['micIN']; ?>" name="t29"></td><td><b>USB Port</b></td><td><input type="text" value="<?php echo $row['USBPort']; ?>" name="t29"/></td><td><b>HDMI Port</b></td><td><input type="text" value="<?php echo $row['HDMIPort']; ?>" name="t30"/></td><td></td><td></td></tr>
