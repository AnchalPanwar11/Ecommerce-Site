...
<tr><td><div id="sidediv2"></div></td></tr>
<tr><td><div id="sidediv1"><label style="position:relative; left:110px; top:10px"><a href="#"><b>Menu 2</b></a></label></div></td></tr>
<tr><td><div id="sidediv2"></div></td></tr>
<tr><td><div id="sidediv1"><label style="position:relative; left:110px; top:10px"><a href="#"><b>Update Profile</b></a></label></div></td></tr>
<tr><td><div id="sidediv2"></div></td></tr>
<tr><td><div id="sidediv1"><label style="position:relative; left:110px; top:10px"><a href="#"><b>Menu 4</b></a></label></div></td></tr>
<tr><td><div id="sidediv2"></div></td></tr>
<tr><td><div id="sidediv1"><label style="position:relative; left:110px; top:10px"><a href="#"><b>Menu 5</b></a></label></div></td></tr>
<tr><td><div id="sidediv2"></div></td></tr>
...
<tr><td colspan="4"><label style="position:relative; color:#06F; font-size:24px; left:400px; top:3px"><b>UPDATE PROFILE</label></td></tr>
<tr><td width="250"></td><td><b>Company Name</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['CName'];?>" name="c1" /></font></td><td width="400"></td></tr>
<tr><td></td><td><b>Company Id</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['CId'];?>" name="c2" /></font></td><td></td></tr>
<tr><td></td><td><b><font style="position:relative; text-decoration:underline">Address:</font></b></td><td></td><td></td></tr>
<tr><td></td><td><b>Country</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['Country'];?>" name="c3" /></font></td><td></td></tr>
<tr><td></td><td><b>State</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['State'];?>" name="c4" /></font></td><td></td></tr>
<tr><td></td><td><b>City</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['City'];?>" name="c5" /></font></td><td></td></tr>
<tr><td></td><td><b>Landmark</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['Landmark'];?>" name="c6" /> </font></td><td></td></tr>
<tr><td></td><td><b>Pincode</b></td><td><font color="#666666"><input type="number" value="<?php echo $row['Pincode'];?>" name="c7" /></font></td><td></td></tr>
<tr><td></td><td><b>Mobile Number</b></td><td><font color="#666666"><input type="number" value="<?php echo $row['Mobno'];?>" name="c8" /></font></td><td></td></tr>
<tr><td></td><td><b>Company Registration Number</b></td><td><font color="#666666"><input type="number" value="<?php echo $row['CRegNo'];?>" name="c9" /></font></td><td></td></tr>

<tr><td></td><td></td><td><input type="submit" value="update" name="c10" /></td><td></td></tr>
