...
<form method="post" action="updateCustomerPhp.php">
<center>
<div id="maindiv">
<div id="div2">
...
<tr><td width="250"></td><td><b>Customer Name</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['CUName'];?>" name="c1" /></font></td><td width="400"></td></tr>
<tr><td></td><td><b>E-mail Id</b></td><td><font color="#666666"><input type="text" value="<?php echo $row['CUEmailId'];?>" name="c2" /></font></td><td></td></tr>
...
<tr><td></td><td></td><td><input type="submit" value="update" name="c9" /></td><td></td></tr>
