...
<center>
<form method="post" action="updateStatusPhp.php">
<div id="maindiv">
<div id="div2">
...
$res=mysql_query("select *from addcartlap where CId='$a1'");
...
<div id="div8twoA">
<table  cellpadding="0" cellspacing="0" height="130">
...
<tr><td><label style="font-size:22px;"><b>ORDER DETAILS</b></label></td></tr>
<tr><td height="8"></td></tr>
<tr><td><b>Company Id</b></td><td><?php echo $row['CId']; ?></td></tr>
<tr><td><b>Vendor Code</b></td><td><?php echo $row['VCode']; ?></td></tr>
<tr><td><b>Order ID</b></td><td><?php echo $row['OrderID']; ?></td></tr>
<tr><td><b>Sales Package</b></td><td><?php echo $row['salesPak']; ?></td></tr>
<tr><td><b>Quantity</b></td><td><?php echo $row['Quantity']; ?></td></tr>
<tr><td><b>Order Date</b></td><td><?php echo $row['Date']; ?></td></tr>
<tr><td><b>Delivery Date</b></td><td><?php echo $row['DDate']; ?></td></tr>
<tr><td><b>Device Type</b></td><td><?php echo $row['DevType']; ?></td></tr>
<tr><td><label style="font-size:22px;"><b>CUSTOMER'S DETAILS</b></label></td></tr>
<tr><td><b>Customer Name</b></td><td><?php echo $row['CUName']; ?></td></tr>
<tr><td><b>Email Id</b></td><td><?php echo $row['CUEmailId']; ?></td></tr>
<tr><td><b>Country</b></td><td><?php echo $row['Country']; ?></td></tr>
<tr><td><b>State</b></td><td><?php echo $row['State']; ?></td></tr>
<tr><td><b>City</b></td><td><?php echo $row['City']; ?></td></tr>
<tr><td><b>Landmark</b></td><td><?php echo $row['Landmark']; ?></td></tr>
<tr><td><b>Pincode</b></td><td><?php echo $row['Pincode']; ?></td></tr>
<tr><td><b>Mobile No</b></td><td><?php echo $row['MobNo']; ?></td></tr>
<tr><td><b>Status</b></td><td><select name="r2"><option>Cancelled</option><option>Delivered</option><option>Pending</option></select></td></tr>
<tr><td></td><td><form method="post" action="updateStatusPhp.php"><input type="text" value="<?php echo $row['OrderID']; ?>" name="r1"><input type="submit" value="Submit"></form></td></tr>
<tr><td>&nbsp;</td><td></td></tr>
</table>
</div>
<?php
