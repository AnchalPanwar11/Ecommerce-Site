...
$res=mysql_query("select *from laptopdet");
while($row=mysql_fetch_array($res))
{
?>
<form method="post" action="newlaptop.php">
<div id="myproduct">
<table  height="250" width="1100">
<tr><td rowspan="4" height="200" width="220"><div id="picdiv"><img src="../cameraroll/laptopimg.png" height="180" width="200" style="position:relative; left:10px; top:5px" /></div></td><td><label style="position:relative; left:60px"><b>Price</b></label></td><td><font color="#999999"><?php echo $row['Price']; ?></font></td><td><label style="position:relative;"><b>SSD Capacity</b></label></td><td><font color="#999999"><?php echo $row['SSDCap']; ?></font></td><td width="50"></td></tr>
<tr><td><label style="position:relative; left:-13px"><center><b>Processor Brand</b></center></label></td><td><font color="#999999"><?php echo $row['ProBrand']; ?></font></td><td><label style="position:relative;"><b>Processor Name</b></label></td><td><font color="#999999"><?php echo $row['ProName']; ?></font></td><td></td></tr>
<tr><td><label style="position:relative; left:60px"><b>RAM</b></label></td><td><font color="#999999"><?php echo $row['RAM']; ?></font></td><td><label style="position:relative;"><b>Operating System</b></label></td><td><font color="#999999"><?php echo $row['OS']; ?></font></td><td></td></tr>
<tr><td><label style="position:relative; left:60px"><b>Series</b></label></td><td><font color="#999999"><?php echo $row['Series']; ?></font></td><td><label style="position:relative;"><b>No. of Cores</b></label></td><td><font color="#999999"><?php echo $row['NoCore']; ?></font></td><td></td></tr>
<tr><td><input type="hidden" value="<?php echo $row['DevType']; ?>" name="z1"/></td></tr>

<tr><td></td><td></td><td></td><td><input type="hidden" value="<?php echo $row['CId']; ?>" name="t1" /></td><td></td></tr>
<tr><td></td><td></td><td></td><td></td><td><a href="newlaptop.php"><input type="submit" value="Read more" /></a></td></tr>
</table>
</div>
<div id="linediv"></div>
</form>
