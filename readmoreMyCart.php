...
<tr><td><input type="submit" value="Add to Cart"/></td><td><input type="submit" value="Buy Now"/></td></tr>
</table>
</div>
...
<div id="div8oneB">
<table cellpadding="0" cellspacing="0" height="80" width="500">
<tr><td><form method="post" action="addtocartMobilePhp.php"><input type="hidden" name="n1" value="<?php echo $row['PCode']; ?>" ><input type="hidden" name="n2" value="<?php echo $row['Price']; ?>" ><input type="hidden" name="n3" value="<?php echo $row['ModName']; ?>" ><input type="hidden" name="n4" value="<?php echo $row['VCode']; ?>" ><input type="hidden" name="n5" value="<?php echo $row['ModNum']; ?>" ><input type="submit" value="Add to Cart"/></form></td><td><input type="submit" value="Buy Now"/></td></tr>
</table>
</div>
</td><td><div id="div8two">
<div id="div8twoA">
