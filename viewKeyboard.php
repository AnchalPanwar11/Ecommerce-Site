...
{
?>
<form method="post" action="newKeyboard.php">
<div id="myproduct">
<table  height="220" width="1100">
<tr><td rowspan="4" height="200" width="220"><div id="picdiv"><img src="images/home/product2.jpg" height="180" width="200" style="position:relative; left:10px; top:5px" /></div></td><td><label style="position:relative; left:60px"><b>Price</b></label></td><td><font color="#999999"><?php echo $row['Price']; ?></font></td><td><label style="position:relative;"><b>Sales Package</b></label></td><td><font color="#999999"><?php echo $row['salePak']; ?></font></td><td width="50"></td></tr>
<tr><td><label style="position:relative; left:-13px"><center><b>Case Material</b></center></label></td><td><font color="#999999"><?php echo $row['CaseM']; ?></font></td><td><label style="position:relative;"><b>OS Supported</b></label></td><td><font color="#999999"><?php echo $row['OSSup']; ?></font></td><td></td></tr>
<tr><td><label style="position:relative; left:60px"><b>Designed For</b></label></td><td><font color="#999999"><?php echo $row['Designed']; ?></font></td><td><label style="position:relative;"><b>Backlit</b></label></td><td><font color="#999999"><?php echo $row['Backlit']; ?></font></td><td></td></tr>
<tr><td><input type="hidden" value="<?php echo $row['DevType']; ?>" name="z1"/></td></tr>
<tr><td></td><td></td><td></td><td><input type="hidden" value="<?php echo $row['VCode']; ?>" name="t1" /></td><td></td></tr>
<tr><td></td><td></td><td></td><td></td><td><a href="newKeyboard.php"><input type="submit" value="Read more" /></a></td></tr>
</table>
</div>
<div id="linediv"></div>
</form>
